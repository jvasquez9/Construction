...
public abstract class QPrecedesPeParent extends GlobalScopeParent {
	...
	public String getFormula(String P_ltl, String Q_ltl, int numProposition) {
		...
		String firstPart = secondAndHelper(Q_ltl, afterAndRPart);
	...
	protected abstract String secondAndHelper(String Q_ltl, String afterAndRPart);
}
